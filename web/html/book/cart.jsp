...
<div class="layui-container strategy">
    <form class="layui-form">
        <s:iterator value="list">
            <div class="layui-row layui-col-md-offset1 strategy-inner cart" id="f-<s:property value="bid"/>">
                ...
                <div class="layui-input-block checkBox">
                    <input type="checkbox" title="购买" id="<s:property value="bid"/>" lay-filter="check">
                    <button id="<s:property value="bid"/>-btn" class="layui-btn layui-btn-danger del" style="height: 12%;line-height: 20px">删除</button>
                </div>
            </div>
...
<div class="layui-row">
    <button class="layui-btn layui-btn-danger" style="float: right;margin: 10px 150px 20px 0" id="buy">立即下单</button>
    <p style="font-size: 25px;float: right;margin: 10px 100px 0 0">
        总金额：<span style="color: red;" id="sum"></span>
    </p>
</div>
